...
- **⚠️ Never link resold standalone attraction tickets.** Table Mountain Cableway states that tickets bought via any website other than **Webtickets** are **not valid**. **Guided tours including the cable car ARE fine** — registered operators hold dedicated Webtickets accounts and buy through the official channel. The test is *"did the seller buy through an official channel?"*, not *"tour or ticket?"*. Check any attraction's resale terms before linking a ticket product — **Robben Island next to verify**. See `affiliates.md`.
